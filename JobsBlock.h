...
typedef __kindof LuckyWheelView *_Nullable (^JobsRetLuckyWheelViewByPointerDirectionBlock)(JobsDirection direction);
...
typedef __kindof JobsTransitionAnimator *_Nullable(^JobsReturnAnimatorByTransDirectionBlock)(JobsDirection direction);
